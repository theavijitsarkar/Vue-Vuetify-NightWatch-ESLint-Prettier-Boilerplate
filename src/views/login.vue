<template app>
  <v-container fluid fill-height class="loginOverlay gradient-custom">
    <v-layout flex align-center justify-center>
      <v-flex xs12 sm8 elevation-6>
        ...
        <v-card>
            ...
            <div>
              <v-form ref="form">
                ...
                <v-layout justify-space-between style="margin-top: 20px;">
                  <v-btn v-on:click="userSignIn" id="loginBtn" color="success"
                    >Login</v-btn
                  >
                </v-layout>
              </v-form>
          ...
          <v-card-actions>
            <v-alert id="successLogin" :value="logginSuccess" type="success">
              Successful Login.
            </v-alert>

            <v-alert id="errorLogin" :value="logginError" type="error">
              Error while logging in. Try with admin admin.
            </v-alert>
          </v-card-actions>
        </v-card>
      </v-flex>
